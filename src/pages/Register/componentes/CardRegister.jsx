...
import { starRegister } from '../helpers/StartReg';
...
export const CardRegister = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      starRegister(user.userName, user.password, navigate);//llama al metodo starLogin del helper 
    }
  }
      ...
      <Card  style={{ width: '600px' }}>
        ...
        <Card.Body>
          ...
          <div className="text-center m-3 ">
            <h2 className="fw-bold">Start Admin</h2>
